...
6.Run supra-ui - This is used to test 'authorization-code' grant_type
	Directly run from eclipse.			
	From Browser:
		http://localhost:9090/secure
		http://localhost:9090/greetings
