...
public class ValidationUtil {
	...
	public static final String[] ATTACHMENT_AUDIO_TYPES = { "MP3", "WAV" };
	...
	public static final String[] ATTACHMENT_DOCS_TYPES_FILTERED = { "DOC", "DOCX", "PDF", "GIF", "JPG", "JPEG", "PNG" };
	...
	public static boolean isStringValueZero(String strValue) {
		...
		return CommonConstants.STR_ZERO.equalsIgnoreCase(strValue);
	...
	public static boolean isStringValueNotNullAndNotEmpty(Object strVal) {
		...
		if (strVal != null
				&& (!strVal.toString().isEmpty() && !CommonConstants.STR_QUESTION_MARK.equals(strVal.toString()))) {
	...
	public static boolean isArrayNotNullAndNotEmpty(Object strVal) {
		...
		if (strVal != null
				&& (Array.getLength(strVal) > 0 && !CommonConstants.STR_QUESTION_MARK.equals(strVal.toString()))) {
	...
	public static String validateStringValue(boolean required, int minLength, int maxLength, String valStr,
		...
		valStr = CommonUtil.getDefaultIfNull(valStr, null);
	...
	public static boolean validateAttachmentTypeFiltered(String attachmentName) {
		boolean isValid = false;
		...
		if (attachmentName != null && !attachmentName.isEmpty()) {
			...
			if (attachmentName.contains(".")) {
				...
				if (Arrays.asList(ATTACHMENT_DOCS_TYPES_FILTERED).contains(type)) {
	...
	public static boolean validateDateBeforeToday(String dateStr) throws ParseException {
		...
		if (dateStr != null) {
			...
			SimpleDateFormat sdf = new SimpleDateFormat(CommonConstants.DATE_ddMMyyyy);
